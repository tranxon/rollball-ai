...
//!
//! Translates RollBall permission declarations from the manifest
...
/// A WASI directory permission derived from a RollBall permission.
...
/// A WASI network permission derived from a RollBall permission.
#[derive(Debug, Clone, PartialEq, Eq)]
...
/// Map a single RollBall Permission to WASI capabilities.
///
...
/// Map a list of RollBall Permissions into aggregated WASI capabilities.
