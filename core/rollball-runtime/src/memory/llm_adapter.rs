//! LLM adapter — bridges `rollball_core::providers::traits::Provider` to
//! `rollball_grafeo::consolidation::triple_extraction::TripleExtractorLlm`.
//!
...
impl TripleExtractorLlm for ProviderLlmAdapter {
    async fn chat(
        ...
        // Convert grafeo LlmMessage → rollball-core ChatMessage.
