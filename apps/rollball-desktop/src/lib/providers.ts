...
const ANTHROPIC: ProviderDef = {
  ...
  exampleModels: ["Claude 4 Sonnet", "Claude 3.5 Sonnet", "Claude 3 Haiku"],
  needsApiKey: true,
  aliases: [],
};
...
const GROQ: ProviderDef = {
  ...
  authStyle: "bearer",
  keyPlaceholder: "gsk_...",
  exampleModels: ["llama-4-scout", "mixtral-8x7b"],
  needsApiKey: true,
  aliases: [],
...
const MISTRAL: ProviderDef = {
  ...
  exampleModels: ["Mistral Large", "Codestral"],
  needsApiKey: true,
  aliases: [],
};
...
const GLM: ProviderDef = {
  ...
  exampleModels: ["glm-4-plus", "glm-4-flash", "glm-4v"],
  needsApiKey: true,
  aliases: ["zhipu"],
...
const MOONSHOT: ProviderDef = {
  ...
  authStyle: "bearer",
  keyPlaceholder: "sk-...",
  exampleModels: ["moonshot-v1-128k", "moonshot-v1-32k"],
  needsApiKey: true,
  aliases: ["kimi"],
};
...
const QWEN: ProviderDef = {
  ...
  authStyle: "bearer",
  keyPlaceholder: "sk-...",
  exampleModels: ["qwen-max", "qwen-plus", "qwen-turbo"],
  needsApiKey: true,
...
const MINIMAX: ProviderDef = {
  ...
  authStyle: "bearer",
  keyPlaceholder: "API key...",
  exampleModels: ["MiniMax-Text-01", "abab6.5s"],
  needsApiKey: true,
  aliases: [],
};
...
const DOUBAO: ProviderDef = {
  ...
  authStyle: "bearer",
  keyPlaceholder: "API key...",
  exampleModels: ["doubao-pro", "doubao-lite"],
  needsApiKey: true,
  aliases: [],
...
const OLLAMA: ProviderDef = {
  ...
  exampleModels: ["qwen3:8b", "llama3:8b", "deepseek-r1:7b"],
  needsApiKey: false,
  aliases: [],
